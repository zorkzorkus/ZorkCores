...
add_fileset_file AvalonDualPortRam.vhd VHDL PATH AvalonDualPortRam.vhd
add_fileset_file ZworkAlu.vhd VHDL PATH ZworkAlu.vhd
add_fileset_file ZworkAvalon.vhd VHDL PATH ZworkAvalon.vhd TOP_LEVEL_FILE
add_fileset_file ZworkBranch.vhd VHDL PATH ZworkBranch.vhd
add_fileset_file ZworkCore.vhd VHDL PATH ZworkCore.vhd
add_fileset_file ZworkCsr.vhd VHDL PATH ZworkCsr.vhd
add_fileset_file ZworkDecoder.vhd VHDL PATH ZworkDecoder.vhd
add_fileset_file ZworkDivider.vhd VHDL PATH ZworkDivider.vhd
add_fileset_file ZworkFetch.vhd VHDL PATH ZworkFetch.vhd
add_fileset_file ZworkMemory.vhd VHDL PATH ZworkMemory.vhd
add_fileset_file ZworkRegisters.vhd VHDL PATH ZworkRegisters.vhd
...
# parameters
#
add_parameter g_reset_vector STD_LOGIC_VECTOR 4 "Address of the first instruction after reset or power-up."
set_parameter_property g_reset_vector DEFAULT_VALUE 4
...
add_parameter g_mtvec STD_LOGIC_VECTOR 8 "Initial address of the exception vector"
set_parameter_property g_mtvec DEFAULT_VALUE 8
